TEMPLATE = app
TARGET = kangyuanjifen-qt
macx:TARGET = "-I/root/KangYuanJiFen/src/leveldb/helpers-Qt"
VERSION = 0.8.7.4
...
macx:ICON = src/qt/res/icons/kangyuanjifen.icns
